...
const About = () => {
	return (
		<section
			id="about"
			className="py-20 px-5 bg-auto"
			style={{
				background: `url(${back})`,
				
			}}
		>
			<div className="bg-gray-100 bg-transparent/10 p-8 rounded-3xl shadow-xl max-w-6xl mx-auto backdrop-blur-lg  transition-transform ease-in-out">
				{/* About Me Section */}
			...
			<div className="mt-16">
				<div className=" p-8 rounded-3xl shadow-xl max-w-6xl mx-auto backdrop-blur-lg hover:scale-95 transition-transform ease-in-out">
					<h3 className="text-4xl font-semibold bg-gradient-to-r from-gray-100 to-gray-200 text-transparent bg-clip-text text-center mb-8">
						Currently Jamming
					</h3>
					{/* Song Embeds */}
					<div
